...
public class PlayerHealth : MonoBehaviour
{
    ...
    /*  If a destructiblesblock falls on the player, the player isn't jumping (that not being the cause of the relative force measured) 
     *  and the destructible block was inded falling (negative y.velocity).
     *   >>> If the block hits the player with a certain force relative to the player
     *   >> Hurt the player
     */
