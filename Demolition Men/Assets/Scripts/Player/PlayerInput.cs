...
{
    /* This script is made by Pelle, my peer-programmer.
     */
    ...
    private void Update()
    {
        ...
        // Call the connectedControllers which the ControllerManager updates, which assigns the gamepad controls to the right player.
    }
}

// Custom class which later gets filled in with the data/values for each controller.
[System.Serializable]
public class StupidController
{
    ...
    public void Update(int gamepadsConnected)
    {
        ...
        {
            //if controller aren't connected
        ...
        //spring joysticks (controls smoothness of movement)
        ...
        //deadzone
        // magnitude = values of direction of the joysticks.
        // checks if the magnitude is below the set deadzone.
